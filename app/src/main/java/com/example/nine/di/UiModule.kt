...
import com.example.nine.ui.news.DogsViewModel
import dagger.Binds
...
abstract class UiModule {
    ...
    @ContributesAndroidInjector
    abstract fun contributeDogsFragment(): DogsFragment

    @Binds
    @IntoMap
    @ViewModelKey(DogsViewModel::class)
    abstract fun bindDogsViewModel(viewModel: DogsViewModel): ViewModel
}
